...
* 📂 **Source Code:** [![Open In Colab]([https://colab.research.google.com/assets/colab-badge.svg](https://colab.research.google.com/drive/1zDMmn_w5vRAgycphbwAK2lSlEmEJE1Vf?usp=sharing))].
* 📚 **Thư viện cần thiết:**
    * `numpy`
    * `pandas`
    * `scikit-learn`
